...
public class NodeH2Star extends Node implements Comparable<NodeH2Star>{
    public NodeH2Star(String prevAction, HashMap<Pair, Ship> ships, Node parent, int deaths, int blackBoxesDamaged, int curCapacitiy, Pair cgCoordinates, HashSet<Pair> visitedCells, int depth) {

...
public class NodeH2 extends Node implements Comparable<NodeH2>{
    public NodeH2(String prevAction, HashMap<Pair, Ship> ships, Node parent, int deaths, int blackBoxesDamaged, int curCapacitiy, Pair cgCoordinates, HashSet<Pair> visitedCells, int depth) {
